...
const {
  ...
  hashPassword, generateTokenOnSignup, generateVerificationLink
} = Helpers;
...
class AuthController {
  ...
  static async userSignup(req, res) {
    try {
      ...
      const isSent = await sendMail({
        email, emailTemplateId: 'd-598aa2e6e00b4c938278c24eeb62cc17', firstName, urlLink: verificationLink
      });
      const { token } = user;
  ...
  static async supplierSignup(req, res) {
    try {
      ...
      const emailSent = await sendMail({
        email, emailTemplateId: 'd-0e0b3c582ec04e7fb6cff2bd12b9b0ba', firstName, urlLink: verificationLink, companyToken: unhashedCompanyToken
      });
  ...
  static async companySignUp(req, res) {
    try {
      ...
      const emailSent = await sendMail({
        email, emailTemplateId: 'd-0e0b3c582ec04e7fb6cff2bd12b9b0ba', firstName, urlLink: verificationLink, companyToken
      });
  ...
  static async sendResetPasswordEmail(req, res) {
    try {
      ...
      const response = await sendMail({
        email, emailTemplateId: 'd-a47cbbf0e90e469b92dc5329a0659b32', firstName, urlLink: resetUrl
      });
